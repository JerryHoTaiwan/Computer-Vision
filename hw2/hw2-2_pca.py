...
if __name__ == '__main__':
    ...
    for n in [3, 10, 39]:
        for k in [1, 3, 5]:
            eigen = eigenfaces[:n]
            valid_vec_0 = img2vec(valid_img_0, mean_face, n, eigen)
            valid_vec_1 = img2vec(valid_img_1, mean_face, n, eigen)
            valid_vec_2 = img2vec(valid_img_2, mean_face, n, eigen)

            test_vec = img2vec(test_img, mean_face, n, eigen)
